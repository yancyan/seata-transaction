...
alter table ORDER_TEST
    add constraint PK_ORDER_TEST primary key (ID) using index
  tablespace ${table_space}
    pctfree 10
    initrans 2
    maxtrans 255
...
CREATE SEQUENCE "SEQ_ORDER_TEST" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 10000 CACHE 20 NOORDER  NOCYCLE;
